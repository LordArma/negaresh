...
require_once __DIR__ . '/includes/negaresh-dashboard.php';
...
$GLOBALS['negaresh_dashboard'] = new Negaresh_Dashboard($GLOBALS['negaresh_bulk'], $GLOBALS['negaresh_settings']);
